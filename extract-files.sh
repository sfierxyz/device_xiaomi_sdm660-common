...
setup_vendor "$DEVICE_COMMON" "$VENDOR" "$FLUID_ROOT" true $CLEAN_VENDOR
...
if [ -s "$MY_DIR"/../$DEVICE_SPECIFIED_COMMON/proprietary-files.txt ];then
    ...
    setup_vendor "$DEVICE_SPECIFIED_COMMON" "$VENDOR" "$FLUID_ROOT" false "$CLEAN_VENDOR"
...
if [ -s "$MY_DIR"/../$DEVICE/proprietary-files.txt ]; then
    ...
    setup_vendor "$DEVICE" "$VENDOR" "$FLUID_ROOT" false "$CLEAN_VENDOR"
